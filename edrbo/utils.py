...
def sample_context_for_L_calculation(N, bounds):
    '''
    :param bounds: bounds of contexual variable '2 x d'.
    :param N: Number of samples.
    :return: 'N' x 'd' samples.
    '''
    # print("bounds shape", bounds.shape)
    return torch.rand((N, bounds.shape[1])) * (bounds[1] - bounds[0]) + bounds[0]